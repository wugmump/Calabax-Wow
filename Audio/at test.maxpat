...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 128.0, 114.0, 22.0 ],
					"text" : "CyTone 1 @foo 8 hi"
				}
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-20::obj-10" : [ "vst~[10]", "vst~[4]", 0 ],
			"obj-20::obj-12" : [ "vst~[11]", "vst~[1]", 0 ],
			"obj-20::obj-9" : [ "vst~[15]", "vst~[15]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
