...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 288.0, 49.0, 22.0 ],
					"text" : "forward"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 96.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 32.0, 401.0, 47.0 ],
					"text" : "Input: patcherargs right outlet\nArgument: # 1 (same as enclosing patch's first arg; = an instance number)\nAny \"r #1_argname\" will output the arg value on load"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 212.0, 82.0, 22.0 ],
					"text" : "prepend send"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 176.0, 48.0, 22.0 ],
					"text" : "pv attrs"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.0, 128.0, 172.0, 22.0 ],
					"text" : "t b b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 63.0, 96.0, 204.0, 22.0 ],
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 16.0, 64.0, 66.0, 22.0 ],
					"text" : "route done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 139.5, 176.0, 95.5, 22.0 ],
					"text" : "combine #1 _ s"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 257.5, 158.5, 72.5, 158.5 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 148.5, 260.5, 72.5, 260.5 ],
					"source" : [ "obj-19", 0 ]
				}
